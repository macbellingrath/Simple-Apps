...
var name: String?  = "Jo"
func makeHelloString() throws -> String? {
    if let name = name {
     return "Hello \(name)"
    }
   throw printError.NoName
}



func printHelloString(stringMakerFunction: (() throws -> String?)) rethrows {
    


   try stringMakerFunction()
...
try! printHelloString(makeHelloString())
